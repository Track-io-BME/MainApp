...
class ProfileViewModel(application: Application) :
    ...
    var username   = MutableLiveData(SharedPrefConfig.getString(SharedPrefConfig.pref_username, "USERNAME"))
    var gender     = MutableLiveData(SharedPrefConfig.getString(SharedPrefConfig.pref_gender, application.getString(R.string.male)))
